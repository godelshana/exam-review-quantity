...
def validate_review(q,r):
    ...
    for k in ('topic','level','difficultyReason','fastPath','normalPath','fastBoundary','fastMethod','skipReason','trap','familyId','computedAnswer','verification'):
